...
struct ColorsHelper {
    ...
    static let downButton = UIColor(displayP3Red: 255/255, green: 208/255, blue: 0, alpha: 1)
    ...
    static func createGradientColor(bounds: CGRect) -> UIColor? {
        ...
        gradient.colors = [ColorsHelper.upButton.cgColor, ColorsHelper.leftButton.cgColor, ColorsHelper.rightButton.cgColor, ColorsHelper.downButton.cgColor]
